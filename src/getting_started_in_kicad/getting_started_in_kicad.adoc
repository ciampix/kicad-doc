...
|B.Cu Copper |Bottom Layer |.GBL
|F.Cu Component |Top Layer |.GTL
|F.SilkS SilkS_Cmp |Top Overlay |.GTO
|B.Mask Mask_Cop |Bottom Solder Resist |.GBS
|F.Mask Mask_Cmp |Top Solder Resist |.GTS
|Edge.Cuts Edges_Pcb |Edges |N/A
|=========================================================
