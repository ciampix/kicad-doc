...
image::images/en/Calculation1.svg[alt="Regulators",scaledwidth="50%"]
...
image::images/en/Calculation2.svg[alt="Regulators",scaledwidth="50%"]




This current is typically below stem:[100 \mu A] and can be neglected with caution.

To use this calculator, enter the parameters of the regulator (_Type_,

V_ref and, if needed, I_adj ,select the field you want to calculate 
